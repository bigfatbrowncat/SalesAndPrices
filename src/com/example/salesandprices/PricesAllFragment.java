...
public class PricesAllFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.fragment_prices_all, container, false);
	
		ListView priceList = (ListView)root.findViewById(R.id.prices_list_view);
		
		try {
			pricesDataManager.updateDatabaseFromDataFile();
			Product[] products = pricesDataManager.getAllProductsListWithShortDescriptions();
	 ...
	 * @return
	 */
	public static PricesAllFragment newInstance() {
		PricesAllFragment res = new PricesAllFragment();
